        ...
        <div className="space-y-12 text-zinc-300 font-light leading-relaxed text-lg pb-16">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 pl-4 border-l border-zinc-800">
              <div>
                ...
                <p>When you register for our pageant events, Dancing events And Others Events subscribe to our newsletter, or contact us through our Site, we may collect personal information that includes, but is not limited to:</p>
              ...
              <div className="pt-4">
                <strong className="text-white block mb-2">Non-Personal Information</strong>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-8 space-y-2 text-zinc-400">
              ...
              <li>To communicate with you about updates, changes, and promotional offers</li>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 pl-4 border-l border-zinc-800 text-zinc-400">
              ...
              <p><strong className="text-white">Legal Requirements:</strong> We may disclose your information if required to do so by law or in response to valid requests by public authorities.</p>
              <p><strong className="text-white">Business Transfers:</strong> In the event of a merger, acquisition, or other business reorganization, your information may be transferred to the new entity.</p>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 pl-4 border-l border-zinc-800 text-zinc-400">
              ...
              <p><strong className="text-white">Opt-Out:</strong> You may opt-out of receiving promotional communications from us by following the unsubscribe instructions in those communications or contacting us.</p>
              <p><strong className="text-white">Cookies:</strong> You can manage your cookie preferences through your browser settings. Note that disabling cookies may affect the functionality of our Site.</p>
            </div>
          </section>
