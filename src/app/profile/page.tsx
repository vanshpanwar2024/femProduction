    ...
    <div className="pt-32 pb-20 px-6 min-h-screen">
      <div className="max-w-3xl mx-auto space-y-12 bg-zinc-900 border border-zinc-800 p-8 md:p-12 shadow-2xl">
        <div className="space-y-4">
          <h1 className="text-3xl md:text-4xl font-light tracking-widest uppercase text-white">Profile Details</h1>
          <div className="w-16 h-px bg-zinc-600"></div>
          <p className="text-zinc-400 mt-6 text-sm">Manage your VogueEvents account and personal information.</p>
        </div>
        ...
        <div className="pt-8 border-t border-zinc-800">
          <p className="text-zinc-500 italic">Connected via {user.provider === "google" ? "Google Authentication" : "Native Account"}.</p>
        </div>
      </div>
    </div>
  );
