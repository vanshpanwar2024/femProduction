      ...
      <div className="max-w-4xl mx-auto space-y-16 relative z-10">
        ...
        <div className="space-y-16 text-zinc-300 font-light leading-relaxed text-lg pb-16">
          ...
          <section className="space-y-4 pt-8">
            ...
            <p>
              Founded in 2019 by <strong className="text-white font-medium">Vikas Jamdagni, Manoj Sangwan and Vivek Panwar</strong> as co-founders, with <strong className="text-white font-medium">Pankaj Kumar</strong> as project coordinator, Fem House Pvt Ltd has emerged as a pioneer in pageantry and entertainment.
            </p>
            <p>
